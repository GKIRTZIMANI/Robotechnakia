...
Για να ολοκληρωθεί το έργο μας, περιμένουμε να ανοίξουν τα σχολεία για να κάνουμε την ομαδική παρουσίαση στην οποία θα συνεργαστούν τα τρία ρομποτάκια και στο τέλος να τραγουδήσουμε όλοι μαζί το τραγούδι μας για την Κλιματική Αλλαγή.
